...
export class ProductsComponent {
  products: Product[] = [
    ...
    },
    {
      ...
      description: 'Флагманский iPhone 16 вобрал в себя лучшие черты современного гаджета.',
    ...
    },
    {
      ...
      description: 'Флагманская модель iPhone 16 Pro подчеркивает ваши неограниченные возможности.',
      imageUrls: ['assets/fifth.jpeg'],
      rating: 4.8,
